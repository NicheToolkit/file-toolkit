...
public class FileServiceImpl implements FileService {
    ...
    @Autowired
    protected FileProperties commonProperties;
    ...
    @Resource
    protected StoreService fileStoreService;

    @Resource
    protected VideoRequestHandler videoHttpRequestHandler;
    ...
    public void download(FileIndex fileIndex, String filename, String contentType, Boolean preview, FileType fileType, HttpServletRequest request, HttpServletResponse response) throws RestException {
        ...
        if (fileType == FileType.VIDEO && preview) {
            request.setAttribute(VideoRequestHandler.VIDEO_FILE, fileIndex);
            try {
